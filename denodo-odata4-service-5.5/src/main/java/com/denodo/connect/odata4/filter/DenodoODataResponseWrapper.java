...
public final class DenodoODataResponseWrapper extends HttpServletResponseWrapper{
    ...
    public DenodoODataResponseWrapper(final HttpServletResponse response, final String serviceRoot, final String dataBaseName) {
        super(response);
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        synchronized (this) {
            if (this.outputStream == null) {
                this.outputStream = new DenodoODataOutputStream(super.getOutputStream(), this.serviceRoot, this.dataBaseName, this.getCharacterEncoding());
            }
