...
Platform installation listening on localhost:9090. This can be changed at the
...
context called "denodo-odata4-service" for a .war file called
"denodo-odata4-service.war".
